...
<aside id="left-sidebar-nav">
    <ul id="slide-out" class="side-nav fixed leftside-navigation">
                ...
                <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-editor-insert-invitation"></i> Lịch</a>
                    <div class="collapsible-body">
                        <ul>
                            ...
                            <li><a href="css-icons.html">Sổ y bạ</a>
                            </li>
                            <li><a href="css-shadow.html">Sổ khám bệnh</a>
                            </li>
                        </ul>
                    </div>
                </li>
        ...
        <li class="no-padding">
            <ul class="collapsible collapsible-accordion">
                <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-maps-directions"></i> Bản đồ</a>
                    <div class="collapsible-body">
                        <ul>
                            <li><a href="css-typography.html">Phòng khám nhi</a>
                            </li>                                        
                            <li><a href="css-icons.html">Phòng tiêm chủng</a>
                            </li>
                            <li><a href="css-shadow.html">Nhà thuốc</a>
                            </li>
                        </ul>
                    </div>
                </li>

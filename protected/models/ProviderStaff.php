...
/**
 * This is the model class for table "tbl_provider_staff".
 *
 * The followings are the available columns in table 'tbl_provider_staff':
 * @property integer $id
 ...
 */
class ProviderStaff extends CActiveRecord
{
	/**
	 ...
	 * @return ProviderStaff the static model class
	 */
